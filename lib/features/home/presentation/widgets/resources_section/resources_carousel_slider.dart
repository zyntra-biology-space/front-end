...
class ResourcesCarouselSlider extends StatefulWidget {
  const ResourcesCarouselSlider({super.key});

  @override
  State<ResourcesCarouselSlider> createState() =>
      _ResourcesCarouselSliderState();
}

class _ResourcesCarouselSliderState extends State<ResourcesCarouselSlider> {
